...
namespace Pente.Controllers
{
    ...
    public class PenteController : INotifyPropertyChanged
    {
        ...
        public bool isTria = false;
        public bool isTessera = false;
                    ...
                    if (!(xTran == 0 && yTran == 0))
                    {
                            ...
                            TestColor(x + (xTran * 3), y + (yTran * 3), whitePlayer))
                        {
                            ...
                            if (whitePlayer)
                            {
                                ...
                                if (WhiteCaptureCount == 5 && !isTesting)
                                {
                            ...
                            else
                            {
                                ...
                                if (notWhiteCaptureCount == 5 && !isTesting)
                                {
        ...
        public int CheckRow(int x, int y, int xTran, int yTran, bool playerColor)
        {
            int highestCount = 0;
            int inARowCount = 0;
